...
#define SCOPE(x) KdPrint(("-------------------------------------------\n")); \
				 KdPrint(("Entering function scope for "x"\n")); \
				 KdPrint(("-------------------------------------------\n"))
#define DESCOPE() KdPrint(("-------------------------------------------\n")); \
				  KdPrint(("Releasing scope\n")); \
				  KdPrint(("-------------------------------------------\n"))
...
typedef struct syscall_offsets_s
{
	int iNtCreateProcess;
	int iNtGdiCreateCompatibleDC;
	int iNtGdiGetPixel;
	int iNtGdiExtEscape;
}syscall_offsets_t;
...
#define FILE_DEVICE_FELITE 0x00002a8d
#define IOCTL_FELITE_INITIALIZE (ULONG)CTL_CODE(FILE_DEVICE_FELITE, 0x01, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
extern syscall_offsets_t gTableOffsets;
#define GAME_EXECUTABLE "hl.exe"
#endif
